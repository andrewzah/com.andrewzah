...
Our results can be summarized as follows. We find that over substantial time periods, spacing has powerful (and typically nonmonotonic) effects on retention, with optimal memory occurring when spacing is some modest fraction of the final retention interval (perhaps about 10%–20%). [1](#elrf)
...
-   \[<span id="intervals"></span>\] [Guide to Anki Intervals and Learning Steps](https://www.youtube.com/watch?v=1XaJjbCSXT0)
-   \[<span id="elrf"></span>\] [Enhancing learning and retarding forgetting: Choices and consequences, Pashler, Rohrer, Cepeda, & Carpenter (2007)](https://s3.amazonaws.com/andrewzah.com/studies/Pashler.Rohrer.Cepeda.Carpenter_2007.pdf)
-   \[<span id="mflv"></span>\] MAINTENANCE OF FOREIGN LANGUAGE VOCABULARY AND THE SPACING EFFECT, Bahrick Et al (1993)\[<https://s3.amazonaws.com/andrewzah.com/studies/Bahrick-et-al-1993-spacing-effect.pdf>\]
-   \[<span id="lka"></span>\] Low-Key Anki\[<https://massimmersionapproach.com/table-of-contents/anki/>\]
-   \[<span id="t89s"></span>\] Targeting an 80-90% Success Rate in Anki\[<https://eshapard.github.io/anki/target-an-80-90-percent-success-rate-in-anki.html>\]
-   \[<span id="lkanpb"></span>\] Low-Key Anki: No Penalties or Boosting\[<https://massimmersionapproach.com/table-of-contents/anki/low-key-anki/low-key-anki-no-penalties-or-boosting/>\]
-   \[<span id="lkarsz"></span>\] Low-Key Anki: ResetEZ\[<https://massimmersionapproach.com/table-of-contents/anki/low-key-anki/low-key-anki-no-penalties-or-boosting/>\]
