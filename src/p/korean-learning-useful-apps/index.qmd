...
The downside is LLMs are absolutely terrible for the environment. But go ahead, enjoy
a conversation with the BS slop generator in exchange for gallons of water.
...
using AI (read: unverified perhaps-correct slop) instead of just working with native speakers.
...
ChatGPT is a BS generator that can't actually reason, and therefore doesn't know when it's wrong.
Sometimes it's right, but often it's wrong, and the frustrating part is the wording is exactly the same.

Un-learning incorrect information from slop is more work than learning correct information in the first place.
This is my "old man yells at cloud" moment but there is a *glut* of information available online, for free, for most languages.
We can refer to that instead of random slop.
